    ...
    <div class="w-full lg:w-3/4 mx-auto px-3 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 lg:h-18 gap-4">
            ...
            <div class="hidden lg:flex items-center gap-1 rounded-full border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 px-4 py-2">
                ...
                <a href="{{ route('importation') }}" class="px-4 py-2 rounded-full text-sm font-medium transition-all {{ request()->routeIs('importation') ? 'bg-green-400 text-black shadow-sm' : 'text-black dark:text-white hover:bg-black/10 dark:hover:bg-white/10' }}">Importation</a>
                <a href="{{ route('shipping') }}" class="px-4 py-2 rounded-full text-sm font-medium transition-all {{ request()->routeIs('shipping') ? 'bg-green-400 text-black shadow-sm' : 'text-black dark:text-white hover:bg-black/10 dark:hover:bg-white/10' }}">Shipping</a>
                <a href="{{ route('inspection') }}" class="px-4 py-2 rounded-full text-sm font-medium transition-all {{ request()->routeIs('inspection') ? 'bg-green-400 text-black shadow-sm' : 'text-black dark:text-white hover:bg-black/10 dark:hover:bg-white/10' }}">Inspection</a>
                <a href="{{ route('advisory') }}" class="px-4 py-2 rounded-full text-sm font-medium transition-all {{ request()->routeIs('advisory') ? 'bg-green-400 text-black shadow-sm' : 'text-black dark:text-white hover:bg-black/10 dark:hover:bg-white/10' }}">Advisory</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden border-t border-black/10 dark:border-white/10 py-3 space-y-1">
            ...
            <a href="{{ route('importation') }}" class="block px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('importation') ? 'bg-green-400 text-black' : 'text-black dark:text-white hover:bg-black/10 dark:hover:bg-white/10' }}">Car Importation</a>
            <a href="{{ route('inspection') }}" class="block px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('inspection') ? 'bg-green-400 text-black' : 'text-black dark:text-white hover:bg-black/10 dark:hover:bg-white/10' }}">Inspection Reports</a>
            <a href="{{ route('shipping') }}" class="block px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('shipping') ? 'bg-green-400 text-black' : 'text-black dark:text-white hover:bg-black/10 dark:hover:bg-white/10' }}">Shipping &amp; Clearing</a>
            <a href="{{ route('history') }}" class="block px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('history') ? 'bg-green-400 text-black' : 'text-black dark:text-white hover:bg-black/10 dark:hover:bg-white/10' }}">Vehicle History</a>
            <a href="{{ route('tradein') }}" class="block px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('tradein') ? 'bg-green-400 text-black' : 'text-black dark:text-white hover:bg-black/10 dark:hover:bg-white/10' }}">Trade-In Program</a>
            <a href="{{ route('advisory') }}" class="block px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('advisory') ? 'bg-green-400 text-black' : 'text-black dark:text-white hover:bg-black/10 dark:hover:bg-white/10' }}">Advisory</a>
            ...
            <a href="{{ route('privacy') }}" class="block px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('privacy') ? 'bg-green-400 text-black' : 'text-black dark:text-white hover:bg-black/10 dark:hover:bg-white/10' }}">Privacy Policy</a>
            <a href="{{ route('terms') }}" class="block px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('terms') ? 'bg-green-400 text-black' : 'text-black dark:text-white hover:bg-black/10 dark:hover:bg-white/10' }}">Terms of Service</a>
